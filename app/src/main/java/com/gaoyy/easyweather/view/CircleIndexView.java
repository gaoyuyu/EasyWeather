package com.gaoyy.easyweather.view;
...
public class CircleIndexView extends View
{
    ...
    public void updateIndex(int value)
    {
        ...
        Log.i(TAG, "inSweepAngle===>" + inSweepAngle);
        ValueAnimator valueAnimator = ValueAnimator.ofFloat(0f, inSweepAngle);
        ...
        ValueAnimator valueAnimator1 = ValueAnimator.ofInt(0, value);
        valueAnimator1.setDuration(300);
        valueAnimator1.setStartDelay(150);
